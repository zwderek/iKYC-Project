...
class WeConnect:
    ...
    def update_profile(self, customer_id: int, name: str = None, gender: str = None, birthday: str = None,
                       email: str = None, pic: str = None, welcome_msg: str = None, is_public: bool = None) -> int:
        """
        Args:
            customer_id:
            name: name to update
    ...
    def update_profile_pic(self, customer_id: int, pic: str = None) -> int:
        ...
        return self.update_profile(customer_id,
                                   name=None, gender=None, birthday=None, email=None, pic=pic, welcome_msg=None,
                                   is_public=None)
    ...
    def update_profile_public(self, customer_id: int, is_public: int = None) -> int:
        ...
        """
        return self.update_profile(customer_id,
                                   name=None, gender=None, birthday=None, email=None, pic=None, welcome_msg=None,
                                   is_public=is_public)

    # A.5 Create User Profile
    # private method
    def _create_profile(self, customer_id: int, name: str = None, gender: str = None, birthday: str = None,
                        email: str = None, pic: str = None, welcome_msg: str = None, is_public: bool = 0) -> int:
        """
        Create user profile
        Args:
            customer_id:
        ...
        try:
            ...
            entry = Util.fitArray(entry)
            sql = "INSERT INTO Profile (`profile_id`, `customer_id`, `name`, `gender`, `birthday`, `email`, `pic`, `welcome_msg`, `is_public`) VALUES ({}, {}, {}, {}, {}, {}, {}, {}, {});".format(
                *entry)
            self.cursor.execute(sql)
            # self.myconn.commit()
        except BaseException:
    ...
    def search_transaction(self, from_account_id: int = None, to_account_id: int = None, date_left: str = None,
                           date_right: str = None,
                           time_left: str = None, time_right: str = None, amount_low: int = None,
                           amount_high: int = None) -> list:
        """
    ...
    def make_transaction(self, from_account: int, to_account: int, amount: int) -> int:
        ...
        try:
            ...
            self.cursor.execute(
                "UPDATE Account SET balance = {} WHERE account_id = {}".format(from_balance - amount, from_account))
            ...
            self.cursor.execute(
                "UPDATE Account SET balance = {} WHERE account_id = {}".format(to_balance + amount, to_account))
            self.myconn.commit()
        except BaseException:
            return ReturnStatus.DATABASE_ERROR
        return ReturnStatus.OK
